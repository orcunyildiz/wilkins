...
// --- ranks of producer task for multiple prod-cons example---
void producer1_f (Wilkins* wilkins,
                 std::string prefix,
...
int main(int argc, char* argv[])
{
    ...
    producer1_f(wilkins, prefix, threads, mem_blocks, domain, global_nblocks, dim, local_npoints);
}
